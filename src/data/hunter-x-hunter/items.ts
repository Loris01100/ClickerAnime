...
export const hunterXHunterItems: GameData["items"] = [
  ...
  // Keep the legacy id so existing saves retain the item after the content replacement.
  { id: "hxh-item-fil-nen", kind: "unique", name: "Yeux écarlates", effects: [{ target: "teamDps", kind: "percent", value: 0.2 }] },

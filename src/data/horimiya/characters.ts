...
export const horimiyaCharacters: GameData["characters"] = [
  ...
  {
    id: "horimiya-yuki", name: "Yuki Yoshikawa", animeId: "horimiya", rarity: "secondary",
    tags: ["student", "friend"], arcIds: ["horimiya-nouveaux-liens", "horimiya-sentiments", "horimiya-quotidien", "horimiya-diplome"],
    baseClickPower: 2, baseDps: 8, passive: { target: "clickPower", kind: "percent", value: 0.15 },
    ability: { id: "horimiya-ability-sourire", name: "Sourire malgré tout", cooldownMs: 50_000, durationMs: 8_000, effects: [{ target: "teamDps", kind: "percent", value: 0.5 }, { target: "clickPower", kind: "percent", value: 0.35 }] },
  },
  {
    id: "horimiya-sengoku", name: "Kakeru Sengoku", animeId: "horimiya", rarity: "main",
    tags: ["student", "student-council"], arcIds: ["horimiya-nouveaux-liens", "horimiya-sentiments", "horimiya-quotidien", "horimiya-diplome"],
    baseClickPower: 2, baseDps: 12, passive: { target: "teamDps", kind: "percent", value: 0.3 },
  },
  {
    id: "horimiya-remi", name: "Remi Ayasaki", animeId: "horimiya", rarity: "secondary",
    tags: ["student", "student-council"], arcIds: ["horimiya-sentiments", "horimiya-quotidien", "horimiya-diplome"],
    baseClickPower: 3, baseDps: 15, passive: { target: "teamDps", kind: "percent", value: 0.18 },
  },
  {
    id: "horimiya-sakura", name: "Sakura Kono", animeId: "horimiya", rarity: "main",
    tags: ["student", "student-council", "cook"], arcIds: ["horimiya-sentiments", "horimiya-quotidien", "horimiya-diplome"],
    baseClickPower: 4, baseDps: 19, passive: { target: "clickPower", kind: "percent", value: 0.3 },
    ability: { id: "horimiya-ability-determination", name: "Détermination silencieuse", cooldownMs: 55_000, durationMs: 8_000, effects: [{ target: "clickPower", kind: "multiplier", value: 2.5 }] },
  },
  {
    id: "horimiya-yanagi", name: "Akane Yanagi", animeId: "horimiya", rarity: "main",
    tags: ["student", "friend"], arcIds: ["horimiya-sentiments", "horimiya-quotidien", "horimiya-diplome"],
    baseClickPower: 4, baseDps: 24, passive: { target: "teamDps", kind: "percent", value: 0.35 },
  },
  {
    id: "horimiya-shu", name: "Shu Iura", animeId: "horimiya", rarity: "main",
    tags: ["student", "friend", "iura-family"], arcIds: ["horimiya-quotidien", "horimiya-pieces-manquantes", "horimiya-diplome"],
    baseClickPower: 7, baseDps: 38, passive: { target: "teamDps", kind: "percent", value: 0.35 },
    ability: { id: "horimiya-ability-entrain", name: "Entrain communicatif", cooldownMs: 60_000, durationMs: 9_000, effects: [{ target: "teamDps", kind: "multiplier", value: 2.75 }] },
  },
  {
  ...
  },
  {
    ...
    baseClickPower: 13, baseDps: 70, passive: { target: "clickPower", kind: "percent", value: 0.4 },
    ability: { id: "horimiya-ability-incruste", name: "Retour imprévisible", cooldownMs: 80_000, durationMs: 11_000, effects: [{ target: "clickPower", kind: "multiplier", value: 3.25 }] },
  },
  {
  ...
  {
    id: "horimiya-motoko", name: "Motoko Iura", animeId: "horimiya", rarity: "main",
    tags: ["student", "iura-family"], arcIds: ["horimiya-pieces-manquantes", "horimiya-diplome"],
    baseClickPower: 15, baseDps: 82, passive: { target: "teamDps", kind: "percent", value: 0.4 },
  },
  {
    id: "horimiya-tanihara", name: "Makio Tanihara", animeId: "horimiya", rarity: "main",
    tags: ["student", "old-friend"], arcIds: ["horimiya-diplome"],
    baseClickPower: 18, baseDps: 90, passive: { target: "clickPower", kind: "percent", value: 0.4 },
  },
  {
    id: "horimiya-yasuda", name: "Makoto Yasuda", animeId: "horimiya", rarity: "secondary",
    tags: ["adult", "teacher"], arcIds: ["horimiya-diplome"],
    baseClickPower: 15, baseDps: 75, passive: { target: "teamDps", kind: "percent", value: 0.2 },
  },
  {
    id: "horimiya-iori", name: "Iori Miyamura", animeId: "horimiya", rarity: "main",
    tags: ["adult", "miyamura-family", "baker"], arcIds: ["horimiya-diplome"],
    baseClickPower: 22, baseDps: 120, passive: { target: "teamDps", kind: "percent", value: 0.45 },
    ability: { id: "horimiya-ability-accueil", name: "Un avenir accueillant", cooldownMs: 90_000, durationMs: 12_000, effects: [{ target: "teamDps", kind: "multiplier", value: 3.5 }] },
  },
];

...
The preference and already-sent milestone names live locally; no player, device, installation or
session id is generated or transmitted. A menu switch makes opposition as easy as acceptance.
...
| `double3` | run duration in minutes on prestige |
